document.addEventListener('DOMContentLoaded', function () {
  ...
  function showFieldError(field, message) {
    ...
    errorEl.className = 'field-error-message form-error-text';
  ...
  function clearFieldError(field) {
    ...
    const existingError = parent.querySelector('.field-error-message, .form-error-text');
    if (existingError) {
  ...
  function validateField(field) {
    ...
    const minLength = field.getAttribute('data-min-length') || field.minLength;
    const isRequired = field.required || field.getAttribute('data-required') === 'true';
    ...
    if (type === 'email' || field.getAttribute('data-type') === 'email') {
    ...
    if (type === 'tel' || field.getAttribute('data-type') === 'phone') {
  ...
  document.addEventListener('input', function (e) {
    const field = e.target;
    if (!field.closest('.contact-form')) return;
    if (!field.classList.contains('field--error') && !field.classList.contains('is-invalid')) return;
  ...
  if (animatableElements.length > 0) {
    if ('IntersectionObserver' in window) {
      ...
      const animationObserver = new IntersectionObserver(function (entries) {
        entries.forEach(function (entry) {
          if (entry.isIntersecting) {
            ...
            const delay = el.getAttribute('data-delay') || el.getAttribute('data-animation-delay') || 0;

            setTimeout(function () {
              el.classList.add('is-visible', 'animated', 'fade-in--visible');
              el.style.opacity = '';
              el.style.transform = '';
            }, parseInt(delay, 10));
      ...
      animatableElements.forEach(function (el) {
        if (!el.classList.contains('is-visible') && !el.classList.contains('animated')) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אגייב ולדימיר משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'a72186f2-ee71-4073-9d20-c5eac9998d25',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'a72186f2-ee71-4073-9d20-c5eac9998d25';
    ...
    function showFallbackContact() {
            ...
            if (mobileToggle && navMenu) {
                ...
                if (phoneHeaderBtn) {
                    phoneHeaderBtn.addEventListener('click', function() {
                        ...
                        // Falls back to 972585240479 placeholder which businessInfoUpdater can replace
        ...
        (function disablePlaceholderLinks() {
            ...
            const socialPlaceholders = [
                ...
                '[social_facebook]',
                'https://instagram.com/ageyevvladimir?igsh=MTZhb2tsejFzMHB5cA==',
                'https://instagram.com/ageyevvladimir?igsh=MTZhb2tsejFzMHB5cA==',
                'https://wa.me/972585240479',
                'https://wa.me/972585240479',
                '[social_twitter]',
                '[social_linkedin]',
                '[social_youtube]',
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'a72186f2-ee71-4073-9d20-c5eac9998d25';
